          ...
          children: [
                  ...
                  children: [
                    ...
                    style: TextStyle(
                      ...
                      Padding(
                        ...
                        child: Text(model.quantityForPrice,
            ...
            Row(
              children: [
                ...
                Text("\$4.99",style: TextStyle(fontSize: 26,fontWeight: FontWeight.bold))
              ],
            ),
            SizedBox(height: 17),
            Container(
            ...
            Container(
             ...
             Row(
              children: [
                SizedBox(width: 30),
                Text("Nutritions",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold),),
                SizedBox(width: 260),
